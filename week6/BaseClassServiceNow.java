...
public String sheetNum;
	...
	@BeforeMethod(groups={"functional","smoke","sanity"})
	...
	@AfterMethod(groups={"functional","smoke","sanity"})
	public void postCondition() throws IOException {
		driver.quit();
	}
	
	@DataProvider
	public String[][] fetchData() throws FileNotFoundException, IOException{
		return ExcelGetData.getData(excelFileName,sheetNum);
	}
}
